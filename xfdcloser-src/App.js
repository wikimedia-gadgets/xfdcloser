...
(function App() {
	...
	// Ensure i18n messages are loaded
	i18n.loaded.then(()=>{
		// Preferences portlet link
		mw.util.addPortletLink("p-cactions", "#", i18n("xfdcloser-example-title")+"/XFDC prefs", "p-xfdc-prefs", "XFDcloser preferences");
